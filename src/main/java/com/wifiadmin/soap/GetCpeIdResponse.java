...
@XmlRootElement(name = "GetCpeIdResponse", namespace = "http://wifi-admin.local/platform/v1")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "GetCpeIdResponse", namespace = "http://wifi-admin.local/platform/v1", propOrder = {"configuration"})
