...
@XmlRootElement(name = "UpdateCpeIdResponse", namespace = "http://wifi-admin.local/platform/v1")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "UpdateCpeIdResponse", namespace = "http://wifi-admin.local/platform/v1", propOrder = {"configuration"})
